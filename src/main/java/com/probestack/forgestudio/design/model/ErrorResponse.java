 ...
 * ErrorResponse
 */
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-18T02:37:18.740676733Z[GMT]")public class ErrorResponse {
  ...
  */
   ...
   * @return errorCode
  */
    @Schema(name = "errorCode", example = "FILE_TOO_LARGE", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   * @return message
  */
  @NotNull   @Schema(name = "message", example = "Validation failed: sizeBytes exceeds the 50MB limit", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
   ...
   * @return path
  */
    @Schema(name = "path", example = "/v1/document", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
